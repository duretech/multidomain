<template>
	<div>
		<b-collapse id="accordion-1" v-model="savedVisible" class="mt-4">
			<div class="row">
				<div class="col-12">
					<h5 class="color-white f-w-100 text-uppercase mt-2">
						{{ $t("savedModules") }}
					</h5>
				</div>
			</div>
											...
											>
												...
												<template v-else>
													<img
														alt="img"
														:src="
															require(`@/assets/img/home/${module.moduleLogoName}`)
														"
														class="align-self-center mr-3 img img-responsive w-40px d-block m-auto"
													/>
												</template>
									...
									<div class="middle">
										<div class="text">
												...
												<div class="col-4">
													...
													>
														...
														<img
															alt="img"
															:src="
																require('@/assets/img/icons/preview_new_active_white.png')
															"
												...
												<div class="col-4">
													...
													>
														...
														<img
															alt="img"
															:src="
																require('@/assets/img/icons/edit_new_active_white.png')
															"
															class="img imgWidth_20px"
														/>
														<p>{{ $t("edit") }}</p>
												...
												<div class="col-4">
													...
													>
														...
														<img
															alt="img"
															:src="
																require('@/assets/img/icons/delete_new_active_white.png')
															"
															class="img imgWidth_20px"
														/>
														<p>
											...
											<div class="row" v-else>
												<div class="col">You are not owner of this module</div>
											</div>
										</div>
									</div>
								</div>
			...
			<div class="col-12" v-else>
				<b-alert variant="info" show>No modules available</b-alert>
			</div>
		</b-collapse>
		<b-modal
			...
			<div class="row">
				<div class="col-10 m-auto">
					<form>
								...
								<div class="input-group">
									...
									<div class="input-group-prepend">
										<div class="dropdown logoSelect-dropdown">
											<button
												type="button"
												class="btn bg-white btn-block form-control"
											>
												{{ $t("browse") }}
									...
									<div class="d-flex row">
										...
										>
											<a class="dropdown-item" href="javascript:void(0)"
												><img
													alt="img"
													:src="require('@/assets/img/home/branding.png')"
											/></a>
										</div>
										<div
											class="col-4"
										...
										>
											<a class="dropdown-item" href="javascript:void(0)"
												><img
													alt="img"
													:src="require('@/assets/img/home/color-wheel.png')"
											/></a>
										</div>
										<div
											class="col-4"
										...
										>
											<a class="dropdown-item" href="javascript:void(0)"
												><img
													alt="img"
													:src="require('@/assets/img/home/drug.png')"
											/></a>
										</div>
										<div
											class="col-4"
										...
										>
											<a class="dropdown-item" href="javascript:void(0)"
												><img
													alt="img"
													:src="require('@/assets/img/home/transform.png')"
											/></a>
										</div>
										<div
											class="col-4"
										...
										<div class="col-4">
											<a class="dropdown-item" href="javascript:void(0)">
												...
												>
													<img
														alt="img"
														:src="require('@/assets/img/home/plus.svg')"
														style="width: 90px"
													/>
													<input
														type="file"
						...
						<div class="row my-3">
							<div class="col-4">
								<label for="module_linkTo">Link To</label>
							</div>
							<div class="col-8">
								<b-form-select
									size="sm"
				...
				<div class="col-10 m-auto">
					<div class="row">
						...
						<div class="col-8">
							<button
								type="button"
								class="btn btn-primary submitbtn submit-create"
		...
		liveSubmit(id) {
			...
			saveConfig.then((res) => {
				...
				response.then((response) => {
					...
					this.reset();
					this.$swal({
						title: this.$i18n.t("moduleUpdateSuccess"),
					});
					this.draftModule = {
						...this.draftModule,
		...
		this.modules = [
			{
				...
				value: `${settings.tableName}_mnch-dashboard`,
			},
			{
				text: this.$i18n.t("family_planning"),
				value: `${settings.tableName}_fp-dashboard`,
			},
		];
		this.selectedModule = `${settings.tableName}_mnch-dashboard`;
	},
};
</script>
...
.newGreen-theme {
	...
	#collapse-1[data-v-107f199a] {
		border-bottom: 2px solid #207f3d;
		padding-bottom: 1%;
	}
}
.newBlack-theme {
...
.firstDivCard {
	.card {
		background-color: #f8775a !important;
	}
}
.secondDivCard {
	.card {
...
.thirdDivCard {
	.card {
		background-color: #299ac2 !important;
	}
}
.commonCardDiv {
	.card {
