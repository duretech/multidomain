			...
			<div class="tab-content" id="myTabContent">
				...
				>
					<div class="row dqrSummaryrow" ref="dqrSummary">
						<div class="col-12">
							<div
								class="card position-relative m-t-20px dqrsummarycard shadow-sm border-t-l-radius-10px border-t-r-radius-10px border-none summarysubcardqr"
							>
								<loader class="cardLoader" v-if="showLoader" />
								<div
									class="card-header p-10px text-decoration-none border-t-l-radius-10px border-t-r-radius-10px"
								>
								...
								<div
									class="card-body dqurcard-body border-b-l-radius-10px border-b-r-radius-10px dqrSummaryContainer mt-0"
								...
								>
									<div>
										<div class="row no-gutters">
											...
											>
												<p
													class="mb-0 font-weight-bold f-s-20px scoretitle fs-25-1920"
												>
													{{ $t("dqrScore") }}
												</p>
												<p
													class="mb-0 font-weight-bold totalscore fs-25-1920"
										...
										<div class="row dashboardchart-container p-b-20px">
											<div class="col-4">
												...
												>
													...
													<div
														class="card-body colBoxtext bg-white border-b-l-radius-10px border-b-r-radius-10px px-2 py-3"
													>
														<div
															class="row mx-0"
											...
											<div class="col-4">
												<div
													class="card m-t-20px bg-transparent shadow-sm border-t-l-radius-10px border-t-r-radius-10px border-none summarysubcardqr offwhite-bg"
												>
													<div
														class="p-10px text-decoration-none border-t-l-radius-10px border-t-r-radius-10px"
													>
                                ...
                                <div class="card bg-transparent border-none shadow-sm border-t-l-radius-10px border-t-r-radius-10px summarysubcardqr">
                                  <div class="card-header p-10px text-decoration-none black-card-header border-t-l-radius-10px border-t-r-radius-10px sub_card-header" :title="$t('externalConsistency_chart1')">
                                    {{$t('externalConsistency_chart1')}}
                                  </div>
                                  <div class="card-body border-b-l-radius-10px border-b-r-radius-10px bg-white p-0" style="height: 450px;padding-top: 26px !important;">
                                    <div class="row no-gutters">
                                      <div class="position-relative col-12">
                                        <div class="my-4 text-center">
                                          {{$t('no_data_to_display')}}
															...
															<!-- <div v-else class="col-lg-6">
                                <div class="card bg-transparent border-none shadow-sm border-t-l-radius-10px border-t-r-radius-10px summarysubcardqr">
                                  <div class="card-header p-10px text-decoration-none black-card-header border-t-l-radius-10px border-t-r-radius-10px sub_card-header" :title="$t('externalConsistency_chart2')">
                                    {{$t('externalConsistency_chart2')}}
                                  </div>
                                  <div class="card-body border-b-l-radius-10px border-b-r-radius-10px bg-white p-0" style="height: 450px;padding-top: 26px !important;">
                                    <div class="row no-gutters">
                                      <div class="position-relative col-12">
