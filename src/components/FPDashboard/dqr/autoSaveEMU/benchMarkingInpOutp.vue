			...
			<div class="row col-lg-12 px-0">
				<div class="col-lg-8">
					<ul class="nav nav-pills mb-3" role="tablist">
						<li class="nav-item" @click="changeFilter('input')">
							<a
						...
						<li class="nav-item" @click="changeFilter('total')">
							<a
			...
			<div class="col-lg-12">
				<div class="saveEMUBtn">
					<a
						...
						class="btn black-btn pointer-events-none color-white m-t-40px float-left mb-5"
						@click="saveFinalEMU"
					>
						{{ $t("save-EMU") }}
					</a>
					...
					await service
						...
						.then((response) => {
							if (
								...
								// //console.log("Empty data found for "+subinpName+" and loation "+sLocId );
							}
						})
						.catch((res) => {
							//console.log(res);
