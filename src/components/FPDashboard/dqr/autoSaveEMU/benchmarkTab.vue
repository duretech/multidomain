    ...
    <div class="row">
      <div class="col-lg-8">
        ...
        <ul class="nav nav-pills mb-3" id="benchmarking-sub-tab" role="tablist">
          <li class="nav-item" v-if="categoryData['Commodities_Client'] && categoryData['Commodities_Client']['disableChart'] == false">
          ...
          <li class="nav-item" v-if="categoryData['Commodities_Facilities'] && categoryData['Commodities_Facilities']['disableChart'] == false">
          ...
          <li class="nav-item" v-if="categoryData['Visits'] && categoryData['Visits']['disableChart'] == false">
          ...
          <li class="nav-item" v-if="categoryData['User'] && categoryData['User']['disableChart'] == false">
        ...
        <div class="tab-content" id="benchmarking-sub-tabContent">
          <div :class="{active : activeTab === 'Commodities_Client', show: activeTab === 'Commodities_Client'}"  class="tab-pane fade" id="benchmarking-comclient" role="tabpanel" aria-labelledby="benchmarking-comclient-tab">
            ...
            tabName="commoditiesToClients" tableName="Commodities Client"
              ...
              :globalResponse="globalResponse" @dataUpdated="updatedFlag" :caltype="caltype" @emittingEMU="saveEMUAuto" @errorOccured="errorOccured"/>
          </div>
...
export default {
  ...
  methods: {
    ...
    switchCategory(data) {
      ...
      ////console.log(preVal)
      this.activeTab = this.dqrResponse.emu_monthly.Background_Data['autoSaveEMU'];
