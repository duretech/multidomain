    ...
    methods: {
        getBackgroundData() {
             ...
             let fromDataStore=  this.dqrResponse.emu["Background_Data"][
              ...
              //       if(sub['selectedDE'][0]){
              //         indId.push(sub['selectedDE'][0].id);
              //         this.keys.push({[sub['selectedDE'][0].id]: sub['static_name']})
              //       }
              //     })
              //   }
              // })
              ...
              //       this.keys.forEach(n=>{
              //         this.fields.push({key: n[data], label: n[data]})
              //         if(n[data] && !n[data].toLowerCase().includes('population')){
              //           obj[n[data]] = oData[res][data] ? oData[res][data]+'%' : '';
              //         }else{
              //           obj[n[data]] = Math.round(oData[res][data])
              //         }
              //       })
