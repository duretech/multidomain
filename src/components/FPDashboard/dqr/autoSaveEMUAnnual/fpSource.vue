      ...
      <div class="modal-body">
        <div class="row mb-2">
          <div class="col-12">
            <download-csv :data="fpItems">
              <a
                class="btn black-btn pointer-events-none color-white float-right"
              >{{$t('exportbtn')}}</a>
            </download-csv>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
            ...
            >{{$t('fpSourceSubTitile1')}}</p>
            <p
              style="font-size: 0.8em;"
            >{{$t('fpSourceSubTitile2')}}</p>
            <b-table
              stripped
              bordered
              hover
        ...
        <div class="row">
          <div class="col-12">
            ...
            <p
              ...
              class="font-italic"
              style="font-size: 0.8em;"
            >Based on above data, review the table below and select from the dropdown to indicate which sectors are included in the service statistics data you have on hand.</p>
            <p
              v-else
              class="font-italic"
              style="font-size: 0.8em;"
            >Based on above data, review the table below and select from the dropdown in the Admin module to indicate which sectors are included in the service statistics data you have on hand.</p>
          </div>
        </div>
        <div
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="col-12 px-0" style="background: #f1f1f1;">
                    <ul
                      class="nav nav-tabs"
                      id="myTab"
                      role="tablist"
                    ...
                    <div class="tab-content py-2 px-3" id="myTabContent">
                      <div
                        ...
                        aria-labelledby="visit-tab"
                         :class="defaultEMU == 'Visits'?'tab-pane fade show active':'tab-pane fade hide'"
                        v-if="FPSource['Visits']"
                      >
                        <div class="insideWrapSec">
                          <div class="row px-3">
                            <div class="col-4 alert alert-secondary">
                              <p class="topSRDiv">{{this.$i18n.t('public_sector')}}</p>
                            </div>
                            <div class="col-4 alert alert-secondary">
                              <p class="topSRDiv">{{this.$i18n.t('public_medical_sector')}}</p>
                            </div>
                            <div class="col-4 alert alert-secondary">
                              <p class="topSRDiv">{{this.$i18n.t('other_source')}}</p>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-4">
                              <div class="form-group">
                                <label for>{{this.$i18n.t('gov_health_facilities')}}</label>
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Visits']['governmentHealth']"
                                    :disabled="isAdmin"
                                  >
                                    <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                                  </select>
                                </div>
                              </div>
                            </div>
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select class="form-control" v-model="FPSource['Visits']['ngo']">
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                                  </select>
                              ...
                              <div class="form-group">
                                <label for>{{this.$i18n.t('private_hospital_clinic_delivery')}}</label>
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Visits']['privateHospital']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                              ...
                              <div class="form-group">
                                <label for>{{this.$i18n.t('pharmacy')}}</label>
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                <label for>{{this.$i18n.t('shop_church_friend')}}</label>
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Visits']['shopChurchFriend']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                      ...
                      <div
                        ...
                        id="cc"
                        role="tabpanel"
                        :class="defaultEMU == 'Commodities_Client'?'show active':'hide'"
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Client']['governmentHealth']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Client']['ngo']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                              ...
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Client']['privateHospital']"
                                  >
                                    <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                              ...
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Client']['pharmacy']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Client']['shopChurchFriend']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                              ...
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Client']['otherSector']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                      ...
                      <div
                        ...
                        :class="defaultEMU == 'Commodities_Facilities'?'show active':'hide'"
                        v-if="FPSource['Commodities_Facilities']"
                      >
                        <div class="insideWrapSec">
                          <div class="row px-3">
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Facilities']['governmentHealth']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Facilities']['ngo']"
                                  >
                                    <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                              ...
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Facilities']['privateHospital']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                              ...
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Facilities']['pharmacy']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Facilities']['shopChurchFriend']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                              ...
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['Commodities_Facilities']['otherSector']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                          ...
                          <div class="row">
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['User']['governmentHealth']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                <label for>{{this.$i18n.t('ngo')}}</label>
                                <div class="select-wrapper">
                                  <select class="form-control" v-model="FPSource['User']['ngo']">
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                                  </select>
                              ...
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['User']['privateHospital']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
                            ...
                            <div class="col-4">
                              <div class="form-group">
                                ...
                                <div class="select-wrapper">
                                  <select
                                    class="form-control"
                                    v-model="FPSource['User']['shopChurchFriend']"
                                  >
                                     <option>{{this.$i18n.t('yes')}}</option>
                                    <option>{{this.$i18n.t('no')}}</option>
                                    <option>{{this.$i18n.t('partially')}}</option>
        ...
        <div class="card my-3">
          <div class="card-header p-10px text-decoration-none">
            <div class="row no-gutters">
              ...
              <div
                class="col-lg-8 col-md-8 p-t-4px card-comp-title"
              >% of Modern Users(by Method) Represented in Your Data - Based on DHS and Table Above</div>
            </div>
          </div>
        ...
        <!-- <div class="row mb-2">
          <div class="col-12">
            <download-csv :data="fpTableItems">
        ...
        <div class="row">
          <div class="col-12">
            <p
              class="textbottom mb-2"
              style="background-color: #d1ecf1; font-size:0.75rem;"
            >{{$t('fpSourceStrip1')}}</p>
            <p
              class="textbottom"
              style="background-color: #fff3cd; font-size:0.75rem;"
            >{{$t('fpSourceStrip1')}}</p>
          </div>
        </div>
      </div>
...
import sectorReporting from "./sectorReporting";
import { decompress } from "compress-json";
export default {
  data() {
   
    return {
      sectors: {"Public Only" : "public_only",
      ...
      FPSource: {
        Commodities_Client: {
          governmentHealth: this.$i18n.t('yes'),
          ngo: this.$i18n.t('yes'),
          otherSector: this.$i18n.t('yes'),
          pharmacy: this.$i18n.t('yes'),
          privateHospital: this.$i18n.t('yes'),
          shopChurchFriend: this.$i18n.t('yes')
        },
  ...
  props: ["selectedLevel", "dqrResponse", "appResponse", "userDetails"],
  components: {
    sectorReporting
  },
  watch: {
  ...
  methods: {
    getUserAccess() {
      let locale = this.$i18n.locale, key = `annualSectorReporting_${locale}`;
      if (!settings.country) {
    ...
    async getFPSourceData() {
      ...
      if (
        ...
        locationID = [
          this.userDetails.dataViewOrganisationUnits[0].id
        ];
        this.defaultLevel =
          this.userDetails.dataViewOrganisationUnits[0].level;
      }
      ...
      let fpData = this.categoryData.Background_Data
        .fpSourceIndicators;
      this.defaultEMU =  this.categoryData.Background_Data.defaultEMU ? this.categoryData.Background_Data.defaultEMU: 'Commodities_Client';
      let count = 0,
        nCount = 0,existMethod = [];
      let response = null;
      if(fromDataStore == "Datastore"){
        ...
        if (!settings.country) {
         ...
         await service.getSavedConfig(key) .then(fpRes => {
              let fpResponse = fpRes && typeof fpRes.data.rows == "string"
              ? {
                  ...fpRes.data,
          ...
          fpData.forEach(res => {
            res.subIndicators.forEach(r => {
              ...
              }else if(!existMethod.includes(static_name)){
              ...
              r.selectedDatastoreDE.forEach(de => {
                ...
                let val = response.data.rows.find(obj=> {
   ...
   /**Note:  need to use return object "combinedObj" in other methods  */
    getFpSourceVals(p_modified, p_fpItems) {
      // console.log(p_modified,p_fpItems)
      let aData = [];
        let combinedObj = {};
      for (let j = 0; j < p_fpItems.length; j++) {
        let nSum = 0;
        for (let k in p_modified) {
          if (p_modified[k] === this.$i18n.t('yes')) {
            nSum += p_fpItems[j][k];
          } else if (p_modified[k] === this.$i18n.t('no')) {
            nSum += 0;
          } else {
    ...
    drawTable(series, categories, fpItems) {
      this.seqFpItems = [];
      Object.keys(fpItems).forEach(key => {
        this.methodSeq.forEach((m, i) => {
          if (m == fpItems[key]["submethod"].split('/')[0]) {
            this.seqFpItems[i] = fpItems[key];
          }
        });
      });
      let valObj = {};
      ...
      valObj[Object.keys(valObj)[0]].forEach((v, i) => {
        ...
        if (
          this.fpItems[i]["submethod"].split('/')[1] == "Male Condom" &&
          fpItems[i]["adjusted"] == true
        ) {
          tempObj[this.$i18n.t('method')] = this.fpItems[i]["method"]+ " ("+this.$i18n.t('adjusted')+")";
        } else if (
          this.fpItems[i]["submethod"].split('/')[1] == "Male Condom" &&
          fpItems[i]["adjusted"] == false
        ) {
          tempObj[this.$i18n.t('method')] = this.fpItems[i]["method"]+ " ("+this.$i18n.t('unadjusted')+")";
        } else {
          tempObj[this.$i18n.t('method')] = this.fpItems[i]["method"];
        }
        ...
        Object.keys(valObj).forEach(tab => {
          ...
          //   fpItems[i]["adjusted"] == true
          // ) {
          //   tempObj["Submethod"] = this.fpItems[i]["submethod"].split('/')[0] + " ("+this.$i18n.t('adjusted')+")";
          // } else if (
          //   this.fpItems[i]["submethod"].split('/')[1] == "Male Condom" &&
          //   fpItems[i]["adjusted"] == false
          // ) {
          //   tempObj["Submethod"] = this.fpItems[i]["submethod"].split('/')[0] + " ("+this.$i18n.t('unadjusted')+")";
          // } else {
            tempObj["Submethod"] = this.fpItems[i]["submethod"].split('/')[0];
          //}

          if (valObj[tab][i].toFixed(2) * 1 > 2) {
      ...
      Object.keys(fpTableItems).forEach(key => {
        this.methodSeq.forEach((m, i) => {
        if (m == fpTableItems[key]["Submethod"]) {
              this.fpTableItems[i] = fpTableItems[key];
            }
        });
          // if (fpTableItems[key]["Submethod"].includes('('+this.$i18n.t('adjusted')+')') || fpTableItems[key]["Submethod"].includes('('+this.$i18n.t('unadjusted')+')')
          // ) {
          //   this.fpTableItems.push(fpTableItems[key]);
          // }
      });
    ...
    drawChart(fpItems) {
      ...
      let series = [],
       combinedObj={},
        ...
        catName = {
          ...
          Commodities_Facilities: this.$i18n.t('commodities_Distributed_to_Facilities')
        };
      ...
      for (let i in this.categoryData) {
        if (
          ...
          if (i == "Commodities_Client") {
            tempObj["type"] =
              this.$i18n.t('commodities_Distributed_to_Clients')
          } else if (i == "Commodities_Facilities") {
            tempObj["type"] =
              this.$i18n.t('commodities_Distributed_to_Facilities')
          } else if (i == "User") {
         ...
         // console.log(this.sectors, this.categoryData[i]["reportingSector"])
          tempObj["reporting"] = this.$i18n.t(''+ this.sectors[this.categoryData[i]["reportingSector"]]) ;
          ...
          if (this.defaultLevel == this.selectedLevel.split("/")[0]) {
            ofpSource = JSON.parse(JSON.stringify(this.categoryData[i].FPSource));
          } else {
          ...
          for (let j in ofpSource) {
            if (this.defaultLevel == this.selectedLevel.split("/")[0]) {
              if (j != "reporting" && j != "type") {
                oModified[objFpNames[j]] = this.$i18n.t(''+ofpSource[j].toLowerCase()) ;
              }
      ...
      // console.log(this.reportingFields, this.reportingItems, oSectorReporting)
      this.saveFinalEMU(oSectorReporting);
      this.drawTable(series, categories, fpItems);
      ...
      service.getSavedConfig(key).then(res => {
        ...
        if (configData["adjustments"]) {
          configData["adjustments"] = { data: series, cat: categories };
           configData["combinedObj"] = combinedObj;
        }else{
          configData = {"adjustments": { data: series, cat: categories },"combinedObj" : combinedObj};
        }
        /**not used  */
        // if (metaConfigData) {
        //   if (metaConfigData[key]) {
        //     metaConfigData[key]["adjustments"] = {
        //       data: series,
        //       cat: categories
        //     };
        //   } else {
        ...
        service.updateConfig(configData, key).then(response => {
          if (response.data.status === "OK") {
            localStorage.setItem("metaConfig", JSON.stringify(configData));
      ...
      allKeys.then(keys => {
        if (keys.data.includes(key)) {
          ...
          oConfig.then(response => {
            ...
            //this.saveLocalStorage(key, oSectorReporting, "sectorReporting");
          });
        } else {
          dataStore = {
            sectorReporting: {
      ...
      if (metaConfigData) {
        ...
        if (metaConfigData[key]) {
          if (metaConfigData[key][chart]) {
            ...
            metaConfigData[key][chart] = {
              [this.selectedLevel.split("/")[1]]: emuData
            };
          }
        } else {
          metaConfigData[key] = {
