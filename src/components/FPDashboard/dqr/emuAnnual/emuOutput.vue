<template>
  <div>
    ...
    <a
      class="btn black-btn pointer-events-none color-white mx-4 blue-btn mt-25px float-right"
      @click="saveFinalEMU"
...
return obj;
    ...
    drawUserBymethods(p_bFlag) {
      ...
      console.log(this.saveuserTrendsByMethods,this.saveuserTrendsByMethods,"----");
    },
    getMethodData() {
