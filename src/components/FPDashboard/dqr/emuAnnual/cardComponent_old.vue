    ...
    <div class="card">
      <div class="card-header p-10px text-decoration-none">
        <div class="row no-gutters">
          ...
          > -->
          <div class="col-lg-7 col-md-7" :title="chartdata.title" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;">
            <!-- <div class="cardTitleSection text-wrap"> -->
              ...
              ></i>
              {{ chartdata.title }}
              <!-- <p class="title_p m-0">{{ chartdata.title }}</p> -->
            <!-- </div> -->
          </div>
          <div class="col-lg-5 col-md-5" v-if="!bShowIcons">
          <div class="row">
            <div class="col-12 text-right d-flex flex-row-reverse">
              <div class="dropdown float-right ml-2">
                <a
                  class="dropdown-toggle f-s-1-25rem"
                  href="#"
                  role="button"
                ...
                >
                <img src="@/assets/img/icons/export.png" class="img" />
                  <!-- <img
                    src="@/assets/img/icons/download_new.png"
                    class="img imgWidth_15px"
                  />
                  <img
                    src="@/assets/img/icons/download_new_active.png"
                    class="img d-none"
                  /> -->
                </a>
                <div
              ...
              <div class="float-right ml-2">
                <i
                    class="fa fa-table chartType viewType"
                    ref="table_viewType"
                    @click="changeViewType('table_viewType')"
                    :title="$t('tableViewIcon')"
                    v-b-tooltip
                  >
                  </i>
                <!-- <img
                  src="@/assets/img/icons/table_new.png"
                  class="img cursor-pointer imgWidth_20px viewType"
                  ref="table_viewType"
                  @click="changeViewType('table_viewType')"
                  :title="$t('tableViewIcon')"
                  v-b-tooltip
                />
                <img
                  src="@/assets/img/icons/table_new_active.png"
                  class="img cursor-pointer imgWidth_20px d-none"
                /> -->
              </div>
              <div class="float-right ml-2">
                <i
                    class="fa fa-bar-chart chartType viewType active"
                    ref="chart_viewType"
                    @click="changeViewType('chart_viewType')"
                    :title="$t('chartViewIcon')"
                    v-b-tooltip
                  >
                  </i>
                <!-- <img
                  src="@/assets/img/icons/chart_new.png"
                  class="img cursor-pointer imgWidth_20px chartType viewType"
                  ref="chart_viewType"
                  @click="changeViewType('chart_viewType')"
                  :title="$t('chartViewIcon')"
                  v-b-tooltip
                />
                <img
                  src="@/assets/img/icons/chart_new_active.png"
                  class="img cursor-pointer imgWidth_20px d-none"
                /> -->
              </div>
              <div
                    ...
                    >
                      <div class="row no-gutters color-white">
                        ...
                        <div class="col-lg-2">
                          <p class="m-0px">
                            <i
                              :class="[`fa fa-sort-numeric-${option.value}`]"
                            ></i>
                          </p>
                        </div>
                      </div>
              ...
              <div v-if="chartdata.cid" class="dropdown float-right  ml-2">
                ...
                >
                  <i
                      class="fa fa-comments color-white"
                      aria-hidden="true"
                    ></i>
                  <!-- <img
                    src="@/assets/img/icons/comment_new.png"
                    class="img cursor-pointer imgWidth_20px"
                  />
                  <img
                    src="@/assets/img/icons/comment_new_active.png"
                    class="img cursor-pointer imgWidth_20px d-none"
                  /> -->
                </a>
                <div
                  class="dropdown-menu dropdown-menu-right"
                  id="dropdownComments"
                  aria-labelledby="dropdownCommentsLink"
                  @click.stop.prevent
                >
                    ...
                    <div class="card-body h-300px overflow-auto">
                      <div class="row mx-0">
                        ...
                        <div class="col-lg-12 m-t-20px" v-if="canComment">
                          <div
                            class="form-group border-bottom-black row"
                              ...
                              >
                                ...
                                <div class="col-md-10">
                                  <div class="media-body">
                                    ...
                                    <h6
                                      class="font-weight-normal f-s-0-875rem w-100"
                                    >
                                      {{ comment.text }}
                                    </h6>
                                    <div class="row ">
                                      <div
                                        class="col commentsactionlinkcontainer hide"
                                      >
                                        <a
                                          href="#"
                                          :title="$t('like')"
                                      ...
                                      >
                                        ...
                                        <div class="col-md-10">
                                          <div class="media-body">
                                            ...
                                            <h6
                                              class="font-weight-normal f-s-0-875rem"
                                            >
                                            ...
                                            <div class="row">
                                              <div
                                                class="col commentsactionlinkcontainer"
                                              >
                                                <a href="#">
                                                  <i
                                              ...
                                              <div class="col text-right">
                                                <p
                                                  class="f-w-500 commentsdate mb-0"
                                                >
                                                  <i class="fa fa-calendar"></i>
                                                  Feb 17,2020
                                                </p>
              ...
              <span
                  class="fa fa-eye cursor-pointer ml-2 float-right mt-2"
                  v-if="viewType !== 'table_viewType'"
                  v-b-tooltip.hover
                  :title="$t('preview')"
                ...
                ></span>
              <!-- <img
                src="@/assets/img/icons/preview_new.png"
                class="img cursor-pointer imgWidth_20px float-right mt-1 ml-3"
                v-if="viewType !== 'table_viewType'"
                v-b-tooltip.hover
                :title="$t('preview')"
                @click.stop.prevent="fullScreen"
              />
              <img
                src="@/assets/img/icons/preview_new_active.png"
                class="img cursor-pointer imgWidth_20px d-none"
              /> -->
              <div class="float-right ml-2 dave2d" v-if="ddOptions">
                <select
                  class="form-control typeDropdown"
                  style="width: 110px; padding: 2px 2px 2px 5px;"
                  v-model="ddValue"
              ...
              <div
                class="float-right ml-2 dave2d"
                v-if="period && viewType == 'chart_viewType'"
              >
                <b-form-select
                  class="typeDropdown"
      ...
      <div class="row px-3 pt-2 d-none">
