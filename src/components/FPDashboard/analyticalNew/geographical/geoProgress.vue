      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <ul
            ...
            role="tablist"
          >
            <li class="nav-item" @click="activeTab = 'total'">
              <a
                class="nav-link"
            ...
            <li class="nav-item" @click="activeTab = 'methodDetails'">
              <a
                class="nav-link"
                :class="[activeTab !== 'total' ? 'active' : '']"
...
export default {
  ...
  methods: {
    currValue(value) {
      console.log("in currValue", value);
      this.currentValue = value;
    },
    prevValue(value) {
      console.log("in prevValue", value);
          ...
          .then((oGeoModule) => {
            ...
            if (oGeoDataType) {
              ...
              oGeoDataType.chartData.forEach((element) => {
                let { color, static_name } = element.indicator;
                let oData = {
                  name: static_name,
                  de: [],
                  color,
              ...
              service
                ...
                .then((response) => {
                  ...
                  console.log("oCypFactorConf", this.oCypFactorConf);
                  ...
                  this.calculateFlag({
                    ...
                    period: this.period,
                    periodType: this.periodType,
                    oCypFactorConf: this.oCypFactorConf,
                  });
                  this.$store.state.loading = false;
        ...
        .then((oGeoModule) => {
          service
            ...
            .then((emuModule) => {
              ...
              console.log("flagTableData", this.flagTableData);
              this.checkAvailableSources(oGeoModule);
