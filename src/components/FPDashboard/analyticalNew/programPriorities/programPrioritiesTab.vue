  ...
  methods: {
    ...
    async exportPPT() {
      ...
      if (formValues) {
        ...
        //console.log(locationName, period)
    ...
    calculateTrend(cData, sSelectedDE, catArray, trendKey) {
      ...
      // console.log("sSelectedDE", sSelectedDE)
    ...
    calculateSubnationalComparison(key, trendKey, dataKey) {
      // console.log("ppResponse_youth",this.ppResponse_youth)
      let cData =
        this.ppResponse_youth.youth && this.ppResponse_youth.youth[dataKey]
          ...
          : null;
      // console.log("Adolescent_Pregnancy data",key, cData)
      let loadChart = true;
      if (
                ...
                .then((response) => {
                  ...
                  if (response.data.rows.length) {
                    ...
                    catArray.forEach((dx) => {
                      ...
                      // console.log("rData", key, trendKey, dataKey, rData);
                      // return
    ...
    getIndicatorMapData() {
      // console.log("in getIndicatorMapData")
      let oModuleData = this.ppResponse["PPFP_Service_Provider"];
      // console.log("in getIndicatorMapData", oModuleData.mapData[0].indicator.visible)
      ...
      // console.log("PPFPServiceProMapDataDisable", this.PPFPServiceProMapDataDisable)
    },
    calculateComparingPPFPUptake() {
      // console.log(
      //   "ppResponse Comparing_PPFP_Uptake",
      //   this.ppResponse["Comparing_PPFP_Uptake"]
      // );
              ...
              .then((response) => {
                ...
                if (response.data.rows.length) {
                  ...
                  Object.keys(rData).forEach((d, j) => {
                    ...
                    // console.log("comparingPPFPUptake",this.comparingPPFPUptake)
                  });
                  ...
                  // console.log("comparingPPFPUptake", this.comparingPPFPUptake);
                  // console.log(
                  //   "this.comparingPPFPUptakeDisable",
                  //   this.comparingPPFPUptakeDisable
                  // );
                } else {
    ...
    calculateTrendsInPPFPRegion() {
      //console.log("ppResponse", this.ppResponse['Trends_in_PPFP_Uptake'])
      let sourceConfig = JSON.parse(
      ...
      if (loadChart) {
        if (sourceConfig != undefined) {
          ...
          // console.log(sSelectedDE, level, this.toolbarLocationID, period)
          period = period.reverse().join(";");
    ...
    calculatePPFPContinnum() {
      ...
      // console.log("ppResponse sourceConfig", this.ppResponse['PPFP_Continuum'])
      let loadChart = true;
      if (
        this.reportChartData &&
        sourceConfig.cid !== this.reportChartData.cid.split("/")[1]
      ...
      if (loadChart) {
        if (sourceConfig != undefined) {
          ...
          // console.log("sSelectedDE",sSelectedDE)
          // console.log("level",level)
          // console.log("toolbarLocationID",this.toolbarLocationID)
          // console.log("period",period)
            ...
            service
              ...
              .then((response) => {
                ...
                if (response.data.rows.length) {
                  ...
                  // console.log("PPFPContinnum",this.PPFPContinnum);
                  let max = 0;
    ...
    calculateOverAllPPFPUse() {
      //console.log("ppResponse", this.ppResponse['Overall_PPFP_Use'])
      let sourceConfig = JSON.parse(
            ...
            service
              ...
              .then((response) => {
                ...
                if (response.data.rows.length) {
                  ...
                  // console.log("this.overAllPPFPUse", this.overAllPPFPUse)
    ...
    calculateComparingPPFPRegion() {
      // console.log(
      //   "ppResponse Comparing_PPFP_Method",
      //   this.ppResponse["Comparing_PPFP_Method"]
      // );
      let sourceConfig = JSON.parse(
            ...
            service
              ...
              .then((response) => {
                ...
                if (response.data.rows.length) {
                  ...
                  // console.log("aCatValue", aCatValue);
