      ...
      <div class="row">
        <div class="col-lg-12 d-none">
          <ul class="nav nav-pills mb-3" id="prog-sub-tab" role="tablist">
            <li
              class="nav-item"
              v-if="chart1Disable || chart2Disable || chart3Disable"
            >
              <a
                class="nav-link"
                :class="{
                  active: chart1Disable || chart2Disable || chart3Disable,
                }"
            ...
            <li class="nav-item" v-if="chart4Disable || chart5Disable">
              <a
                class="nav-link"
                :class="{
                  active:
                    !(chart1Disable || chart2Disable || chart3Disable) &&
                    (chart4Disable || chart5Disable),
                }"
            ...
            <li class="nav-item" v-if="chart6Disable || chart7Disable">
              <a
                class="nav-link"
                :class="{
                  active:
            ...
            >
              <div class="tab-content">
                ...
                <div
                  ...
                  v-if="
                    activeTab === 'access' && (chart4Disable || chart5Disable)
                  "
                >
                  <div class="row dashboardchart-container">
                    <div
  ...
  methods: {
      ...
      if (formValues) {
        ...
        import(/* webpackChunkName: "pptxgenjs"*/ "pptxgenjs").then(
          (pptxgen) => {
            ...
            pptx.subject = this.$i18n.t(
              "barriers_enablers_tab"
            );
            pptx.title = this.$i18n.t(
              "barriers_enablers_tab"
            );
    ...
    getBarriersConfig() {
      ...
      service
        ...
        .catch((e) => {
          this.$store.state.loading = false;
          //  console.log("Failed to fetch adBarrierModule config...")
          if (this.debugging) {
            console.log(
    ...
    getAnchorMapConfig() {
      ...
      service
        ...
        .then((fresponse) => {
          ...
          //console.log(fresponse.data.find(c => c.name === 'Health facility'))
