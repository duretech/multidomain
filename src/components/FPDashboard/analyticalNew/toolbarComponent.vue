		...
		<div class="bottom_toolbar_wrap">
			<form class="input-select-items">
				<div class="form-group pr-3" v-if="showIndicator">
					<label class="text-center">{{ $t("mapIndicator") }}</label>
				...
				<div class="form-group pr-3" v-if="showLocation">
					<label class="text-capitalize text-center">{{ $t("location") }}</label>
					<treeselect
						class="form-control"
						:options="options"
						:show-count="true"
				...
				<div class="pr-3 d-flex justify-content-center align-items-end yearBtn" v-if="showPeriodType">
					<b-button
						v-if="
							$store.state.financialYear.includes('April') &&
							initialSource !== 'EMU'
				...
				<div class="form-group pr-3" v-if="showSource">
					<label class="text-capitalize text-center">{{ $t("dashboardIndicator") }}</label>
					<div class="select-wrapper">
						<select
							class="form-control tabbarselect"
