	...
	<div>
		<b-row class="subheading">
			...
			<b-col class="text-right">
				<div class="location">
					{{ locationName }},
					{{ formSubmitDate ? formSubmitDate : selectedDate }}
				</div>
			</b-col>
		</b-row>
		<b-row class="mt-2 subsubheading">
			<b-col sm="8" class="sectionName">
				<i
			...
			<b-col sm="4" class="" v-if="isViewForms" @click="viewForms">
				<div class="comment">
