        ...
        series: [
          {
            ...
            dataLabels: {
              format:
                ...
                '<span style="font-size:15px;color:white;">{y}/10</span><br/>' +
                "</div>",
            },
          },
        ],
  ...
  methods: {
    setValue() {
      ...
      this.chartOptions.series[0].dataLabels = {
        format: `<div style="text-align:center"><span style="font-size:15px;color:white;">${score}</span><br/></div>`,
      };
