                ...
                <div class="col-12">
                  ...
                  >
                    ...
                    <div class="row m-0 mt-4 mb-2">
                      ...
                      <div
                        class="col-12"
                        v-for="(subIndicator, ind) in chartData[index].indicator
                          .subIndicator"
                        :key="ind"
                      >
                        <div class="row">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              >
                ...
                <div class="row m-0 mb-2" v-if="ind === 0">
                  <div class="col-12">
                    <div class="form-group row">
                      <label
                      ...
                      <div class="col-sm-7 col-lg-6">
                        <vue-editor
                          ...
                          v-model="categoryInfo.Aggregate"
                          :state="categoryInfo.Aggregate !== 0"
                ...
                <div class="row m-0 mb-2" v-if="ind === 2">
                  <div class="col-12">
                    <div class="form-group row">
                      <label
                        for="inputCategoryInfoDerived1"
                        class="col-sm-5 col-lg-6 col-form-label"
                        >{{
                          $t("catInformation")
                        }}</label
                      ...
                      <div class="col-sm-7 col-lg-6">
                        <vue-editor
                          id="inputCategoryInfoDerived1"
                          v-model="categoryInfo.Method"
                          :state="categoryInfo.Method !== 0"
                          :editorToolbar="customToolbar"
                          :placeholder="
                            $t(
                              'enter_category_information'
                ...
                <div
                  ...
                  "
                  :id="
                    'headingChartSettings' + chartBySubtype + chartByType + ind
                  "
                >
                  <h2 class="mb-0">
                    <button
...
<script>
import internalValidation from "@/config/internalValidationConfig.js";
...
export default {
  ...
  data() {
    ...
    let cData =
      internalValidation[this.chartByModule][this.chartByType][
        this.chartBySubtype
      ];

    return {
      derivedCharts: cData.derivedCharts ? cData.derivedCharts : [],
      categoryInfo: cData.categoryInfo
        ? cData.categoryInfo
        : { Aggregate: "", Method: "" },
