                        ...
                        <div v-if="map" class="form-group row">
                          ...
                          <div class="col-sm-7">
                            <b-tabs content-class="mt-3">
                              <b-tab
                                v-for="(levelScale, levelIndex) in chartData[
                                  index
                                ].indicator.levels"
                                :key="levelIndex"
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-7">
                            <input
                              ...
                              class="form-control"
                              placeholder=""
                              v-model="chartData[index].indicator.source"
                            />
                          </div>
                        </div>
                        <div class="form-group row">
            ...
            <div class="card-body border">
              ...
              >
                ...
                <div
                  ...
                  "
                  class="collapse collapse-section-border border"
                  :aria-labelledby="
                    'headingChartSettings' + chartBySubtype + chartByType + ind
                  "
                >
...
<script>
import geographicalConfig from "@/config/geographicalconfig.js";
...
export default {
  ...
  data() {
    let cData = geographicalConfig[this.chartByType][this.chartBySubtype];
    // console.log(cData)
    return {
