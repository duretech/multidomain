    ...
    <div :class="'card-body ' + chartBySubtype">
      ...
      <transition name="slide-fade">
        <div v-if="!disableChart">
          <div class="form-group row" v-if="!hideIndicatorsType">
            <label class="col-sm-5 col-form-label">{{
              $t("indicators_type")
            }}</label>
            <div class="col-sm-7">
              <div class="select-wrapper">
                <select
                  class="form-control"
                  v-model="indicatorsType"
                  :disabled="disableIndicatorsType"
                >
                  ...
                  <div class="col-sm-7">
                    <div class="select-wrapper">
                      <select class="form-control" v-model="chartType">
                        ...
                        <option value="Line" v-if="chartByType !== 'coverage'">
                          {{ $t("line") }}
                        </option>
                        <option value="Area" v-if="chartByType !== 'coverage'">
                          {{ $t("area") }}
                        </option>
                        <option value="Stack" v-if="chartByType === 'coverage'">
                          {{ $t("stack") }}
                        </option>
                      </select>
                    </div>
...
<script>
import config from "@/config/programPrioritiesConfig.js";
...
export default {
  ...
  data() {
    let cData = config.adProgramModule[this.chartByType][this.chartBySubtype];
    return {
