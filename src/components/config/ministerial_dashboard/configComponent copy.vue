              ...
              <div class="col-12">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-7 col-lg-6">
                    ...
                    ></b-form-textarea>
                    <span class="small"
                      >{{ chartInfo.length }}/{{ chartInfoMaxLength }}</span
                    >
                  </div>
                </div>
              </div>
                    ...
                    <div class="col-12">
                      ...
                      >
                        ...
                        <div
                          ...
                          v-if="chartData[index].indicator.subIndicator.length"
                        >
                          ...
                          >
                            ...
                            <b-collapse
                              class="
                                border
                                border-b-l-radius-10px
                                border-b-r-radius-10px
                                mx-3
                                my-2
                              "
                              :id="
...
export default {
  ...
  methods: {
    moveItem(index, places) {
      ...
      if (
        (index === 0 && places === -1) ||
        (index === this.chartData.length - 1 && places === 1)
      ) {
        this.$swal({
          title: "Can't Move",
        });
      } else {
        let temp = this.chartData[index * 1 + places];
        this.chartData[index * 1 + places] = this.chartData[index];
        this.chartData[index] = temp;
        this.updateDOM++;
      }
    },
    ...
    async updateConfigData() {
      ...
      if (this.derivedCharts.length) {
        dCharts = this.derivedCharts.map(async (d) => {
          let cid = "";
