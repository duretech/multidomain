    ...
    >
      ...
      <template v-slot:modal-footer="{ ok, cancel }">
        <b-button
          ...
          variant="primary"
          @click="cancel()"
          class="drill-newbtn newbtn-theme"
        >
          {{ $t("cancelbtn") }}
        </b-button>
        <b-button
          ...
          variant="primary"
          @click="ok()"
          class="drill-newbtn1 newbtn-theme1"
        >
          {{ $t("update") }}
        </b-button>
      </template>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      cTitle: this.chartOptions.title.text,
