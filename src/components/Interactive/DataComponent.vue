<template>
	<b-card-body class="pt-1 pb-1" :key="reusableKey">
		...
		<div class="py-1 fs-17-1920">
			...
			>
				...
				>
				<b-dropdown-text
					class="color-white text-center small"
					v-if="dataSourceGroupList.length === 0"
				>
					No Data Available</b-dropdown-text
				>
			</b-dropdown>
		</div>
...
export default {
	props: ["reusableKey", "isDrillDown", "editDrillDownData"],
	data() {
		return {
			loadMore: false,
			dataOptions: [],
	...
	created() {
		console.log("reusableKey", this.reusableKey);
