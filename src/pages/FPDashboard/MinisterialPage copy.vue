<template>
	<div v-show="!reportChartData">
		...
		>
			...
			<div
				class="sumContainer"
				:class="[inAnalytical ? 'px-0 mt-0' : 'm-t-20px']"
				v-if="
					ministrialData && sendPeriod && sendLocation && globalFactorsData.cyp
				"
				ref="summarySection"
			>
				<div class="row">
								...
								<div class="container-fluid dashboardchartholder px-0">
									<div class="row dashboardchart-container">
										...
										<div
											class=""
											:class="layoutView"
											v-if="key1 || key2 || key3 || key4"
										>
											<swiper :options="swiperOption">
												<swiper-slide v-show="key1">
													<chartComponent
														key="key1"
														cardKey="key1"
														periodLen="13"
										...
										<div
											class="m-t-30px"
											:class="layoutView"
											v-if="key17 || key18 || key19"
										>
											<swiper :options="swiperOption">
												<swiper-slide v-show="key17">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
										...
										<div class="m-t-30px" :class="[layoutView]" v-if="key5">
											<swiper :options="swiperOption">
												<swiper-slide v-show="key5">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
										...
										<div class="m-t-30px" :class="[layoutView]" v-if="key6">
											<swiper :options="swiperOption">
												<swiper-slide v-show="key6">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
										...
										<div class="m-t-30px" :class="[layoutView]" v-if="key7">
											<swiper :options="swiperOption">
												<swiper-slide v-show="key7">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
										...
										<div class="m-t-30px" :class="[layoutView]" v-if="key8">
											<swiper :options="swiperOption">
												<swiper-slide v-show="key8">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
														chartSubCategory="program"
										...
										<div
											class="m-t-30px"
											:class="[layoutView]"
											v-if="key9 || key10 || key11 || key12 || key31"
										>
											<swiper :options="swiperOption">
												<swiper-slide v-show="key9">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
								...
								<div class="container-fluid dashboardchartholder1 px-0">
									<div class="row dashboardchart-container">
										...
										<div
											class=""
											:class="layoutView"
											v-if="key13 || key14 || key15 || key16"
										>
											<swiper :options="swiperOption">
												<swiper-slide v-show="key13">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
														chartSubCategory="Volume"
										...
										<div
											class="m-t-30px"
											:class="layoutView"
											v-if="key28 || key29 || key30"
										>
											<swiper :options="swiperOption">
												<swiper-slide v-show="key28">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
														chartSubCategory="coverage"
										...
										<div class="m-t-30px" :class="layoutView" v-if="key20">
											<swiper :options="swiperOption">
												<swiper-slide v-show="key20">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
														chartSubCategory="RMNCH"
										...
										<div class="m-t-30px" :class="layoutView" v-if="key21">
											<swiper :options="swiperOption">
												<swiper-slide v-show="key21">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
														chartSubCategory="stockOut"
										...
										<div class="m-t-30px" :class="layoutView" v-if="key22">
											<swiper :options="swiperOption">
												<swiper-slide v-show="key22">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
														chartSubCategory="program"
										...
										<div class="m-t-30px" :class="layoutView" v-if="key23">
											<swiper :options="swiperOption">
												<swiper-slide v-show="key23">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
														chartSubCategory="program"
										...
										<div
											class="m-t-30px"
											:class="layoutView"
											v-if="key24 || key25 || key26 || key27 || key32"
										>
											<swiper :options="swiperOption">
												<swiper-slide v-show="key24">
													<chartComponent
														:layoutChanged="layoutView"
														chartCategory="ministrialModule"
														chartSubCategory="reportingRate"
			...
			<div
				class="container-fluid m-t-20px text-center bottomcheckbox_strip d-none"
				v-if="
					ministrialData &&
					sendPeriod &&
					sendLocation &&
					globalFactorsData.cyp &&
					showSummaryViewMore &&
					!inAnalytical
				"
			>
						...
						<div class="d-flex justify-content-center">
							<form>
								<div class="form-check-inline">
									<label class="pr-4 fs-17-1920" style="font-weight: 600"
										>{{ $t("keyIndicator") }} :
									</label>
								</div>
								<div class="form-check-inline pr-3">
									<label class="form-check-label collapsed" for="check1">
										<input
											type="checkbox"
											class="form-check-input"
											id="check1"
											name="vehicle1"
											v-model="dashboardchartholder"
											@click="
												goto(
										...
										/>
										<span
											class="btn black-grey fs-17-1920"
											style="
												font-size: 0.875rem;
												padding: 5px 40px;
												border-radius: 3px;
								...
								<div class="form-check-inline">
									<label class="form-check-label collapsed" for="check2">
										<input
											type="checkbox"
											class="form-check-input"
											id="check2"
											name="vehicle2"
											v-model="dashboardchartholder1"
											@click="
												goto(
													'dashboardchartholder1',
													'dashboardchartholder',
...
export default {
	...
	mixins: [ResetFPMenuMixin, DocumentTitleMixin, LanguageChangeMixin, EmitTourCallbackMixin],
	components: {
		chartComponent,
		toolbarComponent,
		swiper,
	...
	data() {
		// console.log("Ministerial Dashboard initialized @", this.$moment().format('MMMM Do YYYY, h:mm:ss a'))
		return {
			periodType: "monthly",
			sendPeriod: "",
			keyPeriod: "",
	...
	methods: {
		...
		setLocationPeriod(toolbarPeriod, location, locationList, type) {
			// console.log("period, location, type", period, location, type)
			this.activityLogArr = [];
		 ...
		 */
		getConfigAccess() {
			// console.log("getConfigAccess() call started @", this.$moment().format('MMMM Do YYYY, h:mm:ss a'))
			let key = this.generateKey("ministrialModule");
			let namespace = this.reportChartData
				? this.reportChartData.selectedDashboard
				: "";
			// console.log("getConfigAccess() - calling API getSavedConfig() with param '" + key + "' @", this.$moment().format('MMMM Do YYYY, h:mm:ss a'))
			service
				.getSavedConfig(key, false, namespace)
				.then((response) => {
					// console.log("getConfigAccess() - getSavedConfig() with param '" + key + "' response received @", this.$moment().format('MMMM Do YYYY, h:mm:ss a'))
					this.ministrialData = response;
					this.$emit("getConfigDataFP", {
						data: response.data,
						module: "summary",
					});
					let mdData = Object.keys(this.ministrialData.data).filter(
						(m) => m !== "summary"
					);
					// console.log(mdData)
					if (mdData.length === 0) {
					...
					// console.log("getConfigAccess() - call ended @", this.$moment().format('MMMM Do YYYY, h:mm:ss a'))
				})
				.catch(() => {
					// console.log("getConfigAccess() - getSavedConfig() with param '" + key + "' response failed @", this.$moment().format('MMMM Do YYYY, h:mm:ss a'))
		...
		getEMUData() {
			...
			service
				.getSavedConfig(key)
				.then(async (monres) => {
					// console.log("monthly emu",monres)
					...
					// console.log("locIDLabels", locIDLabels)
					...
					// console.log("monres.data[emuDataKey]",monres.data[emuDataKey])
					let eData =
					...
					// console.log("emuData",emuData)
					// console.log("emuMethodData",emuMethodData)
					...
					if (emuData) {
						...
						if (emuObj) {
							...
							// console.log("Formated period",formatedCatArray)
							...
							pe.forEach((p, i) => {
								...
								let formatedDate = null,
									prevDate = null;
								if (this.periodType === "monthly") {
									(formatedDate = this.$moment(p, "YYYYMM").format(
										"MMM YYYY"
									)),
								...
								// console.log("formatedCatArray",formatedCatArray.includes(p))
										...
										if (locID.includes(locKey)) {
											...
											if (innerData) {
												...
												if (i === 0) {
													...
													// console.log(innerData.data[prevCatIndex])
													// console.log(innerData.data[catIndex])
							...
							// console.log("dataArr",this.periodType, dataArr)
							let titleKey = null;
							if (this.periodType === "monthly") {
							...
							if (dataArr && dataArr.length > 0) {
								...
								// console.log("this.exportArr", this.exportArr)
								let foundIndex = this.exportArr.findIndex(
							...
							// console.log("regionalDataArr",regionalDataArr)
							// console.log("regionalTableArr",regionalTableArr)
							if (regionalDataArr && regionalDataArr.length > 0) {
								// console.log(regionalDataArr)
